...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-html/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-html/actions/workflows/validate.yml)

Neovim tree-sitter queries for **html**, part of the
...
- [ ] Changes are scoped to `html` — do not include files for other languages
